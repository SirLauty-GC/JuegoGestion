...
class Menu():
    ...
    def panel_menu_principal(self):
        ...
        pygame.draw.rect(var_glob.screen, color, self.rectangulo_panel_menu_principal)
        self.boton_jugar()
        self.boton_opciones()
        self.boton_salir()
    ...
    def boton_jugar(self):
        ...
        pygame.draw.rect(var_glob.screen, color, self.rectangulo_boton_jugar)
        text_surface = font.render(text, True, text_color)
        text_rect = text_surface.get_rect(center=self.rectangulo_boton_jugar.center)
        var_glob.screen.blit(text_surface, text_rect)
    ...
    def boton_opciones(self):
        ...
        pygame.draw.rect(var_glob.screen, color, self.rectangulo_boton_opciones)
        text_surface = font.render(text, True, text_color)
    ...
    def boton_salir(self):
        ...
        pygame.draw.rect(var_glob.screen, color, self.rectangulo_boton_salir)
        text_surface = font.render(text, True, text_color)
